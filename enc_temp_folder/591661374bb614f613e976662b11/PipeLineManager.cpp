...
Microsoft::WRL::ComPtr<ID3D12RootSignature> PipeLineManager::CreateSkyboxRootSignature(Microsoft::WRL::ComPtr<ID3D12RootSignature> rootSignature) {
    HRESULT hr;
    // RootSignature作成
    D3D12_ROOT_SIGNATURE_DESC descriptionRootSignature{};
    descriptionRootSignature.Flags =
...
Microsoft::WRL::ComPtr<ID3D12PipelineState> PipeLineManager::CreateSkyboxGraphicsPipeLine(Microsoft::WRL::ComPtr<ID3D12PipelineState> graphicsPipelineState, Microsoft::WRL::ComPtr<ID3D12RootSignature> rootSignature, BlendMode blendMode_) {
    HRESULT hr;
