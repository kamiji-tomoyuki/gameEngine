...
static void DemoWindowWidgetsDataTypes()
{
    ...
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        const ImU8    _zero  = 0,   _one  = 1,   _fifty  = 50, _min  = 0,           _max = 255;
        ...
        ImGui::DragScalar("drag ",        ImGuiDataType_U8,     &_v,  drag_speed, drag_clamp ? &_zero  : NULL, drag_clamp ? &_fifty  : NULL, "%u ms");
        ...
        ImGui::SliderScalar("slider  full",       ImGuiDataType_U8,     &_v,  &_min,   &_max,   "%u");
        ...
        ImGui::SliderScalar("slider  reverse",    ImGuiDataType_U8,   &_v,  &_max,    &_min,   "%u");
        ...
        ImGui::InputScalar("input ",      ImGuiDataType_U8,     &_v,  inputs_step ? &_one  : NULL, NULL, "%u", flags);
